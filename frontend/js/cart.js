// frontend/js/cart.js
// Requirements:
// - Keep function names: fetchCartFromApi(), updateQuantity()
// - Integrate GET /api/cart/
// - PATCH/DELETE /api/cart/cart-items/<id>/
  ...
  function bindCheckoutConfirm() {
    ...
    checkoutConfirmBtn.addEventListener('click', async () => {
      try {
        ...
        // Orders API is mounted at /api/orders/ (core router)
