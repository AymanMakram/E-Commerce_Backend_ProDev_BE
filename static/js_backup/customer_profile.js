document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('/api/accounts/countries/')
        ...
        .then(countries => {
            ...
            if (countrySelect && Array.isArray(countries)) {
                countrySelect.innerHTML = '<option value="">272e2a 27442f4429</option>';
                countries.forEach(c => {
    ...
    document.getElementById('profile-form').onsubmit = function(e) {
        ...
        .then(res => res.json())
        .then(data => {
            alert('2a45 2a2d4a2b 2744284a27462a 28462c272d!');
        });
    };
        ...
        if (addAddressBtn && addAddressModal && addAddressForm) {
                ...
                addAddressForm.onsubmit = function(e) {
                        ...
                        if (!city || !street || !country) {
                                alert('4a312c49 2a39282a 2c454a39 27442d4244 2744252c45462a');
                                return;
                        }
