...
function initializeDashboard(token) {
    ...
    function displayProducts(products) {
        ...
        if (products.length === 0) {
            container.innerHTML = '<div class="col-12 text-center py-5"><p class="text-muted">لا توجد منتجات بعد</p></div>';
            return;
        }
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted">الفئة: ${product.category_name}</p>
                        </div>
    ...
    document.getElementById('add-product-form').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert('خطأ في إضافة المنتج: ' + JSON.stringify(error));
            }
        } catch (error) {
    ...
    document.getElementById('save-edit-btn').addEventListener('click', async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const error = await response.json();
                alert('خطأ في تحديث المنتج: ' + JSON.stringify(error));
            }
        } catch (error) {
